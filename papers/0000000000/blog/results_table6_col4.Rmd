...
```{r echo=FALSE}
# Load results
load('est_out/results_table6_col4.RData')
res_final <- results[[1]]
...
devtools::source_url("https://raw.githubusercontent.com/MGanslmeier/ExtremeBoundaryAnalysis/master/src/2build_graph/wrapper.R?token=AKADO6G6KNB5IM5OVP2VN4C56QM2O")
```
